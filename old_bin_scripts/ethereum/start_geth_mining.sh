...
#geth --genesis "$1" --datadir "/media/quantza-lab/DATA/Ethereum" --mine --minerthreads="$THREAD_COUNT" 2>>~/logs/geth_mining.log
geth --datadir "/media/quantza-lab/DATA/Ethereum" --mine --minerthreads="$THREAD_COUNT" 2>>~/logs/geth_mining.log
